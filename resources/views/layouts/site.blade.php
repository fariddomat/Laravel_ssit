...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('home/css/colors/theme-color-11.css') }}">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-2 col-md-3 col-sm-3 col-9">
                        ...
                        <div class="logo" data-animate="fadeInUp" data-delay=".7">
                            <a href="{{ route('home') }}">
                                <img src="{{ asset($info->logo) }}" style="max-height: 70px" alt="SSIT">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 d-none d-sm-block">
                        ...
                        <ul class="client-area text-right list-inline m-0" data-animate="fadeInUp" data-delay="1.1">
                            ...
                            <li><a class="btn btn-secondary" href="">الباقات</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-4">
                    <div class="footer-posts">
                        ...
                        <div class="single-footer-post clearfix" data-animate="fadeInUp" data-delay="{{ .55+($index/10) }}">
                            <span> <a href="{{route('service',$service->slug)}}">{{$blog->updated_at->format('d F
                                Y')}}</a></span>
                            <h4 class="cabin font-weight-normal"><a href="#">{{ $service->title }}</a></h4>
            ...
            <div class="bottom-footer">
                <div class="row">
                    ...
                    <div class="col-md-5 order-last order-md-first">
                        <p class="copyright" data-animate="fadeInDown" data-delay=".85">&copy; Copyright {{ now()->year }}  </p><span>by : <a href="mailto:fariddomat.000@gmail.com">@FaridDomat</a></span>
                    </div>
