...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('home/css/colors/theme-color-1.css') }}">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-2 col-md-3 col-sm-3 col-9">
                        ...
                        <div class="logo" data-animate="fadeInUp" data-delay=".7">
                            <a href="index.html">
                                <img src="{{ asset('home/img/logo.png') }}" alt="VPNet">
                            </a>
                        </div>
                    </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 d-none d-lg-block">
                    ...
                    <div class="banner-image">
                        <img src="{{ asset('home/img/slide.png') }}" alt="" data-animate="fadeInUp" data-delay="1.5" data-depth="0.2">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-service" data-animate="fadeInUp" data-delay=".05">
                            <img src="{{ asset('home/img/icons/security.svg') }}" alt="" alt="" data-no-retina class="svg">>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-service" data-animate="fadeInUp" data-delay=".1">
                            <img src="{{ asset('home/img/icons/speed.svg') }}" alt="" alt="" data-no-retina class="svg">>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-service" data-animate="fadeInUp" data-delay=".15">
                            <img src="{{ asset('home/img/icons/device.svg') }}" alt="" alt="" data-no-retina class="svg">>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-service" data-animate="fadeInUp" data-delay=".2">
                            <img src="{{ asset('home/img/icons/internet.svg') }}" alt="" alt="" data-no-retina class="svg">>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-service" data-animate="fadeInUp" data-delay=".25">
                            <img src="{{ asset('home/img/icons/network.svg') }}" alt="" alt="" data-no-retina class="svg">>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-service" data-animate="fadeInUp" data-delay=".3">
                            <img src="{{ asset('home/img/icons/virus.svg') }}" alt="" alt="" data-no-retina class="svg">>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-service" data-animate="fadeInUp" data-delay=".35">
                            <img src="{{ asset('home/img/icons/bandwidth.svg') }}" alt="" alt="" data-no-retina class="svg">>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-service" data-animate="fadeInUp" data-delay=".4">
                            <img src="{{ asset('home/img/icons/trial.svg') }}" alt="" alt="" data-no-retina class="svg">>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-service" data-animate="fadeInUp" data-delay=".45">
                            <img src="{{ asset('home/img/icons/website.svg') }}" alt="" alt="" data-no-retina class="svg">>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-service" data-animate="fadeInUp" data-delay=".5">
                            <img src="{{ asset('home/img/icons/settings.svg') }}" alt="" alt="" data-no-retina class="svg">>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-service" data-animate="fadeInUp" data-delay=".55">
                            <img src="{{ asset('home/img/icons/team.svg') }}" alt="" alt="" data-no-retina class="svg">>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-service" data-animate="fadeInUp" data-delay=".6">
                            <img src="{{ asset('home/img/icons/money.svg') }}" alt="" alt="" data-no-retina class="svg">>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide single-pricing-slide">
                                    <div class="single-pricing-plan">
                                        <img src="{{ asset('home/img/icons/startup.svg') }}" alt="" alt="" data-no-retina class="svg">>
                                        <h4>Startup</h4>
                                ...
                                <div class="swiper-slide single-pricing-slide">
                                    <div class="single-pricing-plan">
                                        <img src="{{ asset('home/img/icons/enterprise.svg') }}" alt="" alt="" data-no-retina class="svg">>
                                        <h4>Enterprise</h4>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-4 d-none d-md-block">
                    <div class="text-center" data-animate="fadeInUp" data-delay=".1">
                        <img src="{{ asset('home/img/mobile.png') }}" alt="">
                    </div>
                </div>
                <div class="col-lg-6 col-md-8">
                    <div class="app-info">
                        ...
                        <ul class="apps-list list-inline">
                            <li data-animate="fadeInUp" data-delay=".5"><a href="#"><img src="{{ asset('home/img/play-store.png') }}" alt=""></a></li>
                            <li data-animate="fadeInUp" data-delay=".6"><a href="#"><img src="{{ asset('home/img/app-store.png') }}" alt=""></a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <ul class="our-clients list-unstyled d-md-flex align-items-md-center justify-content-md-between m-0">
                <li data-animate="fadeInUp" data-delay=".1">
                    <a href="#" target="_blank"><img src="{{ asset('home/img/brands/brand1.png') }}" alt=""></a></li>
                <li data-animate="fadeInUp" data-delay=".2">
                    <a href="#" target="_blank"><img src="{{ asset('home/img/brands/brand2.png') }}" alt=""></a></li>
                <li data-animate="fadeInUp" data-delay=".3">
                    <a href="#" target="_blank"><img src="{{ asset('home/img/brands/brand3.png') }}" alt=""></a></li>
                <li data-animate="fadeInUp" data-delay=".4">
                    <a href="#" target="_blank"><img src="{{ asset('home/img/brands/brand4.png') }}" alt=""></a></li>
                <li data-animate="fadeInUp" data-delay=".5">
                    <a href="#" target="_blank"><img src="{{ asset('home/img/brands/brand5.png') }}" alt=""></a></li>
                <li data-animate="fadeInUp" data-delay=".6">
                    <a href="#" target="_blank"><img src="{{ asset('home/img/brands/brand6.png') }}" alt=""></a></li>
                <li data-animate="fadeInUp" data-delay=".7">
                    <a href="#" target="_blank"><img src="{{ asset('home/img/brands/brand7.png') }}" alt=""></a></li>
                <li data-animate="fadeInUp" data-delay=".8">
                    <a href="#" target="_blank"><img src="{{ asset('home/img/brands/brand8.png') }}" alt=""></a></li>
                <li data-animate="fadeInUp" data-delay=".9">
                    <a href="#" target="_blank"><img src="{{ asset('home/img/brands/brand9.png') }}" alt=""></a></li>
            </ul>
        </div>
    </section>
    <!-- End of Our clients -->
                    ...
                    <div class="footer-posts">
                        ...
                        <div class="single-footer-post clearfix" data-animate="fadeInUp" data-delay=".55">
                            <a href="#" class="float-left">
                                <img src="{{ asset('home/img/posts/post-t.png') }}" alt="">
                            </a>
                        ...
                        <div class="single-footer-post clearfix" data-animate="fadeInUp" data-delay=".6">
                            <a href="#" class="float-left">
                                <img src="{{ asset('home/img/posts/post-t2.png') }}" alt="">
                            </a>
                            <span>Posted on <a href="#">Jan 19, 2017</a></span>
